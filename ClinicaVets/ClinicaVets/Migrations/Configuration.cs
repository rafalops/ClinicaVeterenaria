namespace ClinicaVets.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ClinicaVets.Models.ClinicaVetsBD>
    {
        ...
        protected override void Seed(ClinicaVets.Models.ClinicaVetsBD context)
        {
