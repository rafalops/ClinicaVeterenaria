namespace ClinicaVets.Migrations
{
    using Models;
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ClinicaVets.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(ClinicaVets.Models.ApplicationDbContext context)
        {
            ...
            var donos = new List<Donos> {
               new Donos  {DonoID=1, Nome = "Luís Freitas", NIF ="813635582", NomeDoUtilizador="a@a.aa" },
               new Donos  {DonoID=2, Nome = "Andreia Gomes", NIF ="854613462", NomeDoUtilizador="b@b.bb" },
